#!/usr/bin/env bash
# One command to issue and verify a receipt for the hiring-agent example.
...
zkml-trail setup model.onnx --name "hiring-agent" --task "score" --calibration sample_input.json
